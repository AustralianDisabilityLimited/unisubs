...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.projects_enabled'
        db.add_column('teams_team', 'projects_enabled', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.projects_enabled'
        db.delete_column('teams_team', 'projects_enabled')
