...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.team_video_language'
        db.delete_column('teams_task', 'team_video_language_id')

        # Adding field 'Task.language'
        db.add_column('teams_task', 'language', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=16, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Task.team_video_language'
        db.add_column('teams_task', 'team_video_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.TeamVideoLanguage'], null=True, blank=True), keep_default=False)

        # Deleting field 'Task.language'
        db.delete_column('teams_task', 'language')
