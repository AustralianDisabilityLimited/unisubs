...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.widget_visibility_policy'
        db.add_column('videos_video', 'widget_visibility_policy', self.gf('django.db.models.fields.CharField')(default=('public',), max_length=32), keep_default=False)

        # Adding field 'Video._site_secret_key'
        db.add_column('videos_video', '_site_secret_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)

        # Adding field 'Video.site_visibility_policy'
        db.add_column('videos_video', 'site_visibility_policy', self.gf('django.db.models.fields.CharField')(default=('public',), max_length=32), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.widget_visibility_policy'
        db.delete_column('videos_video', 'widget_visibility_policy')

        # Deleting field 'Video._site_secret_key'
        db.delete_column('videos_video', '_site_secret_key')

        # Deleting field 'Video.site_visibility_policy'
        db.delete_column('videos_video', 'site_visibility_policy')
    ...
    models = {
        ...
        'videos.video': {
            ...
            '_site_secret_key': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True'}),
            ...
            'site_visibility_policy': ('django.db.models.fields.CharField', [], {'default': "('public',)", 'max_length': '32'}),
            ...
            'widget_visibility_policy': ('django.db.models.fields.CharField', [], {'default': "('public',)", 'max_length': '32'}),
