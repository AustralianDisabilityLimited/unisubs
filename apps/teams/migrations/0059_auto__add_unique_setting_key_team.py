...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Setting', fields ['key', 'team']
        db.create_unique('teams_setting', ['key', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Setting', fields ['key', 'team']
        db.delete_unique('teams_setting', ['key', 'team_id'])
