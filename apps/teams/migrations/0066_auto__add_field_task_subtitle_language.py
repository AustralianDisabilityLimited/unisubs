...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.subtitle_language'
        db.add_column('teams_task', 'subtitle_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Task.subtitle_language'
        db.delete_column('teams_task', 'subtitle_language_id')
