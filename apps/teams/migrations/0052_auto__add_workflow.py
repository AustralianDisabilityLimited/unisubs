...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_workflow', (
            ...
            ('perm_subtitle', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ...
            ('perm_review', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('perm_approve', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('perm_translate', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
    ...
    models = {
        ...
        'teams.project': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'_root'", 'max_length': '50', 'db_index': 'True'}),
        ...
        'teams.workflow': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'perm_approve': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'perm_review': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'perm_subtitle': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'perm_translate': ('django.db.models.fields.PositiveIntegerField', [], {}),
