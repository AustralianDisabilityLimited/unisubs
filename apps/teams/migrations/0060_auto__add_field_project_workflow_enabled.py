...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.workflow_enabled'
        db.add_column('teams_project', 'workflow_enabled', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.workflow_enabled'
        db.delete_column('teams_project', 'workflow_enabled')
