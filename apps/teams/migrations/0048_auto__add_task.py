...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_task', (
            ...
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.TeamVideo'])),
    ...
    models = {
        ...
        'teams.task': {
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.TeamVideo']"})
        },
        'teams.team': {
