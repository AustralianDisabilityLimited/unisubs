...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamVideo.project'
        db.alter_column('teams_teamvideo', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project']))
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamVideo.project'
        db.alter_column('teams_teamvideo', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project'], null=True, blank=True))
