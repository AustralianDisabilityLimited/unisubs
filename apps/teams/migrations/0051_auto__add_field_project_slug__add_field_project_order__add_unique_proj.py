...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teams_project', 'slug', self.gf('django.db.models.fields.SlugField')(default='_root', max_length=50, db_index=True), keep_default=False)

        # Adding field 'Project.order'
        db.add_column('teams_project', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding unique constraint on 'Project', fields ['slug', 'team']
        db.create_unique('teams_project', ['slug', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.slug'
        db.delete_column('teams_project', 'slug')

        # Deleting field 'Project.order'
        db.delete_column('teams_project', 'order')

        # Removing unique constraint on 'Project', fields ['slug', 'team']
        db.delete_unique('teams_project', ['slug', 'team_id'])
