...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_teamlanguagepreference', (
            ('allow_reads', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('allow_writes', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
