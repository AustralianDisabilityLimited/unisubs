...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auth_customuser', 'picture', self.gf('utils.amazon.fields.S3EnabledImageField')(thumb_options={'upscale': True, 'crop': 'smart'}, max_length=100, blank=True))
