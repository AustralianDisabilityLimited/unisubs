...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.body'
        db.alter_column('teams_task', 'body', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'Task.approved'
        db.alter_column('teams_task', 'approved', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Task.body'
        db.alter_column('teams_task', 'body', self.gf('django.db.models.fields.CharField')(max_length=1024, blank=True))

        # Changing field 'Task.approved'
        db.alter_column('teams_task', 'approved', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
