...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideo.project'
        db.add_column('teams_teamvideo', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideo.project'
        db.delete_column('teams_teamvideo', 'project_id')
