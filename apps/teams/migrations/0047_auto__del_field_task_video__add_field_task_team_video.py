...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.video'
        db.delete_column('teams_task', 'video_id')

        # Adding field 'Task.team_video'
        db.add_column('teams_task', 'team_video', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teams.TeamVideo']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Task.video'
        db.add_column('teams_task', 'video', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['teams.TeamVideo']), keep_default=False)

        # Deleting field 'Task.team_video'
        db.delete_column('teams_task', 'team_video_id')
