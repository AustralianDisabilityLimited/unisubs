...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teams_teamvideo', 'thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_options={'upscale': True, 'crop': 'smart'}, null=True, blank=True))

        # Changing field 'Team.logo'
        db.alter_column('teams_team', 'logo', self.gf('utils.amazon.fields.S3EnabledImageField')(thumb_options={'upscale': True, 'crop': 'smart'}, max_length=100, blank=True))
