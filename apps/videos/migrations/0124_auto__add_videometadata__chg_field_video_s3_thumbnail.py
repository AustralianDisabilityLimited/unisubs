...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videos_videometadata', (
            ...
            ('metadata_type', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('videos', ['VideoMetadata'])

        # Changing field 'Video.s3_thumbnail'
        db.alter_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(thumb_options={'upscale': True, 'crop': 'smart'}, max_length=100, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Video.s3_thumbnail'
        db.alter_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, blank=True))
    ...
    models = {
        ...
        'videos.videometadata': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata_type': ('django.db.models.fields.PositiveIntegerField', [], {}),
