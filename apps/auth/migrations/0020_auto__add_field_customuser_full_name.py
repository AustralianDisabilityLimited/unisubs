...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.full_name'
        db.add_column('auth_customuser', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=63, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.full_name'
        db.delete_column('auth_customuser', 'full_name')
