...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.body'
        db.add_column('teams_task', 'body', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True), keep_default=False)

        # Adding field 'Task.approved'
        db.add_column('teams_task', 'approved', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'TeamVideoLanguage', fields ['team_video', 'subtitle_language']
        db.create_unique('teams_teamvideolanguage', ['team_video_id', 'subtitle_language_id'])

        # Deleting field 'Task.body'
        db.delete_column('teams_task', 'body')

        # Deleting field 'Task.approved'
        db.delete_column('teams_task', 'approved')
    ...
    models = {
        ...
        'teams.task': {
            ...
            'approved': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.CustomUser']", 'null': 'True', 'blank': 'True'}),
            'body': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
